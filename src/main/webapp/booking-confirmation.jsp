		...
		<div class="row">
			<div class="col">
				<div>
					...
					<br>
					<div class="card">
						<div class="card-header text-center h4">Booking Details</div>
						<div class="card-body">
									...
									<div id="panelsStayOpen-collapseOne"
										...
										<div class="accordion-body">
											...
											<p class="card-text">
												...
												<span class="float-end">Not confirmed</span>
											</p>
											<br>
								...
								<div class="row g-0">
									<div class="col-md-8">
										<div class="card-body">
											...
											<p class="card-text h6">
												Total amount to be Paid: <span class="h5"><%=search.getTotalTicketPrice()%></span>
											</p>
										</div>
									</div>
									<div class="col-md-4">
